 ...
 * A Chanel-inspired luxury section title with precise animations and sophisticated design
 */
export function SectionTitle({
  ...
  return (
    <div className={`mb-16 md:mb-20 lg:mb-24 relative ${className}`}>
      {/* Luxury section title - Chanel-inspired */}
      <div className={`flex flex-col ${alignmentClasses[align]}`}>
        ...
        >
          <motion.h3
            ...
            transition={{
              ...
              ease: LUXURY_EASING,
              delay: sequenceTimings.subtitle - 0.05,
            }}
          >
            {subtitle}
          </motion.h3>
        ...
        <motion.div
          ...
          transition={{
            duration: animationDurations.long,
            ease: LUXURY_EASING,
            delay: sequenceTimings.title,
          }}
        >
          <motion.h2
            className={`font-alice ${colorScheme[variant].title} text-3xl sm:text-4xl lg:text-[2.75rem] tracking-luxury uppercase font-[350]`}
            initial={{ y: 50 }}
